...
builder.Services.AddScoped<GenerateTwoFactorQrCodeCommandHandler>();
builder.Services.AddScoped<RegenerateRecoveryCodesCommandHandler>();
builder.Services.AddScoped<Enable2FaCommandHandler>();
builder.Services.AddScoped<Disable2FaCommandHandler>();
builder.Services.AddScoped<GetRecoveryCodesCommandHandler>();
